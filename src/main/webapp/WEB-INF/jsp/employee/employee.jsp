...
<body>
    ...
    <table class="border-table">
      <tr style="position: relative">
        <th colspan="6"
          ...
          Accounts
            <button onclick="window.location.href='<%=request.getContextPath() %>/controller/employee/addAccount'"
      ...
      <% 
          ...
          %>
      <tr onclick="window.location.href='<%=request.getContextPath()%>/controller/employee/manageAccount?accountNo=<%=id%>'">
        <td><%=id %></td>
  ...
  <script>
  function redirect(){
  	window.location.href='<%=request.getContextPath()%>/controller/employee/manageAccount?accountNo='+document.getElementById('accountNo').value;
		  }
  </script>
</body>
</html>
