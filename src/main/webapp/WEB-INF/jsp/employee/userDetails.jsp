...
<body>
  ...
  <main class="main">
    ...
    <table class="table" style="margin-top: 5rem;width:50%">
      <tr style="position: relative">
        <th colspan="2"
          ...
          onclick="window.location.href='<%=request.getContextPath()%>/controller/employee/modifyUser?userId=<%=user.getUserId()%>'" alt="edit"
    ...
    <form method="post" action="<%=request.getContextPath() %>/controller/employee/manageUser">
